...
This repository implements SAC and TD3 based on RNN and Transformer architectures.
...
| LRU         | lru        |                                                           | Linear Recurrent Unit (LRU), serial computation               |
...
The performances in classic MuJoCo tasks are as follows
