...
from .dynamics_meta_env_wrapper import DynamicsMetaEnvWrapper
...
def dynamics_mujoco_wrapper(env_name, rand_params, **kwargs):
    env = gym.make(env_name)
    env = DynamicsMetaEnvWrapper(env, rand_params=rand_params, **kwargs)
    return env
