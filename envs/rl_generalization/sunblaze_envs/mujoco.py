...
from roboschool.gym_mujoco_walkers import RoboschoolHalfCheetah as RoboschoolHalfCheetah_
from roboschool.gym_mujoco_walkers import RoboschoolHopper as RoboschoolHopper_
from roboschool.gym_mujoco_walkers import RoboschoolWalker2d as RoboschoolWalker2d_

class RoboschoolHalfCheetah(RoboschoolHalfCheetah_):
    def _reset(self, *args, **kwargs):
        if hasattr(super(), '_reset'):
            return super()._reset(*args, **kwargs)
        return super().reset(*args, **kwargs)

    def _step(self, *args, **kwargs):
        if hasattr(super(), '_step'):
            return super()._step(*args, **kwargs)
        return super().step(*args, **kwargs)

    def _render(self, *args, **kwargs):
        if hasattr(super(), '_render'):
...
class RoboschoolHopper(RoboschoolHopper_):
    def _reset(self, *args, **kwargs):
        if hasattr(super(), '_reset'):
            return super()._reset(*args, **kwargs)
        return super().reset(*args, **kwargs)
    ...
    def _render(self, *args, **kwargs):
        ...
        if 'close' in kwargs:
            ...
            if close:
                return super().close()
        return super().render(*args, **kwargs)
class RoboschoolWalker2d(RoboschoolWalker2d_):
    def _reset(self, *args, **kwargs):
        if hasattr(super(), '_reset'):
            return super()._reset(*args, **kwargs)
        return super().reset(*args, **kwargs)
